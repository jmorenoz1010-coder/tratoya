...
function ProviderIcon({ name }) {
  ...
  if (name === "facebook") {
    return (
      <svg viewBox="0 0 48 48" aria-hidden="true">
        <path fill="#1877F2" d="M24 2C12.95 2 4 10.95 4 22c0 10.417 7.557 19.067 17.457 19.86V31.88h-5.26V22h5.26V17.595c0-5.205 3.1-8.08 7.844-8.08 2.27 0 4.646.404 4.646.404v5.104h-2.617c-2.579 0-3.378 1.6-3.378 3.242V22h5.753l-.92 9.88h-4.833v9.98C36.443 41.067 44 32.417 44 22c0-11.05-8.95-20-20-20Z"/>
      </svg>
    );
  }
  return (
