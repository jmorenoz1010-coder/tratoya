...
export const nextStepFor = (trato, userId) => {
  ...
  if (e === "pago_retenido" && soyVendedor) return { icon: "coin", txt: "El dinero está protegido: registra el envío", cta: "Registrar envío", actionable: true };
...
export const pagoIconKey = (estado) => PAGO_ICON[estado] || "coin";
